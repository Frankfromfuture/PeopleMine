    ...
    <MarketingFrame active="/product">
      <main className="bg-[#fbf7f5] px-6 py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-4 max-w-3xl text-lg text-[#5f646d]">把记录、分析、行动建议与团队协作统一到同一个界面里，避免信息散落。</p>

          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {[
              ["快速录入", "30 秒创建联系人，先记录再补充，减少错过关键关系的概率。", "#f4ede2", "#b8ab8d"],
              ["角色标签", "围绕目标节点建立角色结构，帮助你明确优先级与连接策略。", "#eef1f5", "#a8b3bf"],
              ["能量时间线", "通过关系冷热变化追踪活跃度，主动触发维护动作。", "#f4ede2", "#b8ab8d"],
              ["路径分析", "输入目标后生成关系路径建议，告诉你先联系谁、如何推进。", "#eef1f5", "#a8b3bf"],
          ...
          <div className="mt-14 flex justify-center">
            <Link href="/login" className="rounded-full bg-[#A04F47] px-7 py-3 text-sm font-semibold text-white transition hover:bg-[#A04F47]/90">开始使用</Link>
          </div>
        </div>
      </main>
    </MarketingFrame>
