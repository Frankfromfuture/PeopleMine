    ...
    <MarketingFrame active="/solutions">
      <main className="bg-[#fbf7f5] px-6 py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-2 text-5xl font-semibold text-[#1b1d21]">不同阶段，不同策略，同一套温和高效工作法</h1>
          <p className="mt-4 max-w-3xl text-lg text-[#5f646d]">无论你处于学习期、职业起步期还是业务扩张期，都能找到对应的人脉经营路径。</p>

          <div className="mt-12 space-y-5">
            {[
              ["学生与研究生", "建立导师、校友、实习合作方三层网络，为毕业转型提前布局。", "#f4ede2", "#b8ab8d"],
              ["职场新人", "让零散社交变成可持续关系池，减少临时抱佛脚式联络。", "#eef1f5", "#a8b3bf"],
              ["创业者与业务负责人", "围绕资源节点构建关系航程，提升合作与转介绍效率。", "#f4ede2", "#b8ab8d"],
              ["组织与社群运营者", "把成员关系维护纳入节奏化机制，提高活跃度与黏性。", "#eef1f5", "#a8b3bf"],
          ...
          <div className="mt-14 flex justify-center">
            <Link href="/login" className="rounded-full bg-[#1d1f22] px-7 py-3 text-sm font-semibold text-white">开始试用</Link>
          </div>
        </div>
      </main>
    </MarketingFrame>
