...
export default function LandingNav() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-black/8 bg-[rgba(232,229,224,0.72)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-5 sm:px-8 lg:px-12">
        <Link href="/" aria-label="PeopleMine" className="inline-flex items-center text-[#111]">
          <svg
          ...
          >
            <path d="M120 214C120 186.386 142.386 164 170 164H220C247.614 164 270 186.386 270 214V264C270 291.614 247.614 314 220 314H170C142.386 314 120 291.614 120 264V214Z" fill="url(#landing_lpm_f0)"/>
            <path d="M270 50C270 22.3858 292.386 0 320 0H370C397.614 0 420 22.3858 420 50V100C420 127.614 397.614 150 370 150H320C292.386 150 270 127.614 270 100V50Z" fill="url(#landing_lpm_f1)"/>
            <path d="M270 100C270 127.614 292.386 150 320 150C292.386 150 270 172.386 270 200V214C270 186.386 247.614 164 220 164C247.614 164 270 141.614 270 114V100Z" fill="url(#landing_lpm_f2)"/>
        ...
        <nav className="hidden items-center gap-8 md:flex">
          {NAV_ITEMS.map((item) => (
            <a
              key={item.label}
              href={item.href}
              className="text-[13px] text-[#555] transition hover:text-black"
        ...
        <Link
          href="/login"
          className="inline-flex h-10 items-center justify-center rounded-full bg-[#A04F47] px-5 text-[13px] font-medium text-white transition hover:bg-[#A04F47]/90"
          style={{ fontFamily: FONT_SANS }}
        >
          开始使用
        </Link>
